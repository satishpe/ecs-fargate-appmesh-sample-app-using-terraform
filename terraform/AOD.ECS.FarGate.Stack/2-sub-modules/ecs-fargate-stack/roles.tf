...
// ecs task allow appmesh permissions policy attachment
resource "aws_iam_role_policy_attachment" "ecs_container_registry_poweruser_role" {
  role        = aws_iam_role.ecs_task_execution_role.name
...
// ecs task allow ssm parameter policy attachment
resource "aws_iam_role_policy_attachment" "ecs_container_ssm_reaonly_role" {
  role        = aws_iam_role.ecs_task_execution_role.name
  policy_arn  = "arn:aws:iam::aws:policy/AmazonSSMReadOnlyAccess"
}

// ecs task allow xray policy attachment
resource "aws_iam_role_policy_attachment" "ecs_container_xray_role" {
  role        = aws_iam_role.ecs_task_execution_role.name
  policy_arn  = "arn:aws:iam::aws:policy/AWSXRayDaemonWriteAccess"
}


// ecs task allow secrets read/write
resource "aws_iam_role_policy_attachment" "ecs_container_secrets_role" {
  role        = aws_iam_role.ecs_task_execution_role.name
  policy_arn  = "arn:aws:iam::aws:policy/SecretsManagerReadWrite"
}
